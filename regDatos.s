...
regDatos.o:     file format pe-x86-64
...
0000000000000837 <main>:
 ...
 83f:	e8 00 00 00 00       	call   844 <main+0xd>
 844:	48 8d 05 a8 02 00 00 	lea    0x2a8(%rip),%rax        # af3 <main+0x2bc>
 84b:	48 89 c1             	mov    %rax,%rcx
 84e:	e8 01 f8 ff ff       	call   54 <printf>
 853:	48 8d 45 df          	lea    -0x21(%rbp),%rax
 857:	48 89 c2             	mov    %rax,%rdx
 85a:	48 8d 05 0e 03 00 00 	lea    0x30e(%rip),%rax        # b6f <main+0x338>
 861:	48 89 c1             	mov    %rax,%rcx
 864:	e8 97 f7 ff ff       	call   0 <scanf>
 869:	48 8d 05 0e 01 00 00 	lea    0x10e(%rip),%rax        # 97e <main+0x147>
 870:	48 89 c1             	mov    %rax,%rcx
 873:	e8 88 f7 ff ff       	call   0 <scanf>
 878:	e8 00 00 00 00       	call   87d <main+0x46>
 87d:	48 8d 05 18 03 00 00 	lea    0x318(%rip),%rax        # b9c <main+0x365>
 884:	48 89 c1             	mov    %rax,%rcx
 887:	e8 c8 f7 ff ff       	call   54 <printf>
 88c:	48 8d 45 d8          	lea    -0x28(%rbp),%rax
 890:	48 89 c2             	mov    %rax,%rdx
 893:	48 8d 05 49 03 00 00 	lea    0x349(%rip),%rax        # be3 <main+0x3ac>
 89a:	48 89 c1             	mov    %rax,%rcx
 89d:	e8 5e f7 ff ff       	call   0 <scanf>
 8a2:	48 8d 05 0e 01 00 00 	lea    0x10e(%rip),%rax        # 9b7 <main+0x180>
 8a9:	48 89 c1             	mov    %rax,%rcx
 8ac:	e8 4f f7 ff ff       	call   0 <scanf>
 8b1:	e8 00 00 00 00       	call   8b6 <main+0x7f>
 8b6:	eb 39                	jmp    8f1 <main+0xba>
 8b8:	48 8d 05 18 03 00 00 	lea    0x318(%rip),%rax        # bd7 <main+0x3a0>
 8bf:	48 89 c1             	mov    %rax,%rcx
 8c2:	e8 8d f7 ff ff       	call   54 <printf>
 8c7:	48 8d 45 d8          	lea    -0x28(%rbp),%rax
 8cb:	48 89 c2             	mov    %rax,%rdx
 8ce:	48 8d 05 75 00 00 00 	lea    0x75(%rip),%rax        # 94a <main+0x113>
 8d5:	48 89 c1             	mov    %rax,%rcx
 8d8:	e8 23 f7 ff ff       	call   0 <scanf>
 8dd:	48 8d 05 0e 01 00 00 	lea    0x10e(%rip),%rax        # 9f2 <main+0x1bb>
 8e4:	48 89 c1             	mov    %rax,%rcx
 8e7:	e8 14 f7 ff ff       	call   0 <scanf>
 8ec:	e8 00 00 00 00       	call   8f1 <main+0xba>
 8f1:	8b 45 d8             	mov    -0x28(%rbp),%eax
 8f4:	83 f8 01             	cmp    $0x1,%eax
 8f7:	7e bf                	jle    8b8 <main+0x81>
 8f9:	0f b6 45 df          	movzbl -0x21(%rbp),%eax
 8fd:	0f be c0             	movsbl %al,%eax
 900:	83 f8 70             	cmp    $0x70,%eax
 903:	0f 84 d7 00 00 00    	je     9e0 <main+0x1a9>
 909:	83 f8 70             	cmp    $0x70,%eax
 90c:	0f 8f bc 01 00 00    	jg     ace <main+0x297>
 912:	83 f8 61             	cmp    $0x61,%eax
 915:	74 0e                	je     925 <main+0xee>
 917:	83 f8 65             	cmp    $0x65,%eax
 91a:	0f 84 36 01 00 00    	je     a56 <main+0x21f>
 920:	e9 a9 01 00 00       	jmp    ace <main+0x297>
 925:	b9 30 00 00 00       	mov    $0x30,%ecx
 92a:	e8 00 00 00 00       	call   92f <main+0xf8>
 92f:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
 933:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
 937:	48 89 c1             	mov    %rax,%rcx
 93a:	e8 69 f7 ff ff       	call   a8 <crearProfesor>
 93f:	8b 45 d8             	mov    -0x28(%rbp),%eax
 942:	83 e8 01             	sub    $0x1,%eax
 945:	48 63 d0             	movslq %eax,%rdx
 948:	48 89 d0             	mov    %rdx,%rax
 94b:	48 c1 e0 03          	shl    $0x3,%rax
 94f:	48 29 d0             	sub    %rdx,%rax
 952:	48 c1 e0 03          	shl    $0x3,%rax
 956:	48 89 c1             	mov    %rax,%rcx
 959:	e8 00 00 00 00       	call   95e <main+0x127>
 95e:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
 962:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
 969:	eb 2a                	jmp    995 <main+0x15e>
 96b:	8b 45 fc             	mov    -0x4(%rbp),%eax
 96e:	48 63 d0             	movslq %eax,%rdx
 971:	48 89 d0             	mov    %rdx,%rax
 974:	48 c1 e0 03          	shl    $0x3,%rax
 978:	48 29 d0             	sub    %rdx,%rax
 97b:	48 c1 e0 03          	shl    $0x3,%rax
 97f:	48 89 c2             	mov    %rax,%rdx
 982:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
 986:	48 01 d0             	add    %rdx,%rax
 989:	48 89 c1             	mov    %rax,%rcx
 98c:	e8 c7 f8 ff ff       	call   258 <crearEstudiante>
 991:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
 995:	8b 45 d8             	mov    -0x28(%rbp),%eax
 998:	83 e8 01             	sub    $0x1,%eax
 99b:	39 45 fc             	cmp    %eax,-0x4(%rbp)
 99e:	7c cb                	jl     96b <main+0x134>
 9a0:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
 9a4:	ba 01 00 00 00       	mov    $0x1,%edx
 9a9:	48 89 c1             	mov    %rax,%rcx
 9ac:	e8 4a fa ff ff       	call   3fb <mostrarProfesores>
 9b1:	8b 45 d8             	mov    -0x28(%rbp),%eax
 9b4:	8d 50 ff             	lea    -0x1(%rax),%edx
 9b7:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
 9bb:	48 89 c1             	mov    %rax,%rcx
 9be:	e8 da fb ff ff       	call   59d <mostrarEstudiantes>
 9c3:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
 9c7:	48 89 c1             	mov    %rax,%rcx
 9ca:	e8 00 00 00 00       	call   9cf <main+0x198>
 9cf:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
 9d3:	48 89 c1             	mov    %rax,%rcx
 9d6:	e8 00 00 00 00       	call   9db <main+0x1a4>
 9db:	e9 ef 00 00 00       	jmp    acf <main+0x298>
 9e0:	8b 45 d8             	mov    -0x28(%rbp),%eax
 9e3:	48 63 d0             	movslq %eax,%rdx
 9e6:	48 89 d0             	mov    %rdx,%rax
 9e9:	48 01 c0             	add    %rax,%rax
 9ec:	48 01 d0             	add    %rdx,%rax
 9ef:	48 c1 e0 04          	shl    $0x4,%rax
 9f3:	48 89 c1             	mov    %rax,%rcx
 9f6:	e8 00 00 00 00       	call   9fb <main+0x1c4>
 9fb:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
 9ff:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
 a06:	eb 29                	jmp    a31 <main+0x1fa>
 a08:	8b 45 f8             	mov    -0x8(%rbp),%eax
 a0b:	48 63 d0             	movslq %eax,%rdx
 a0e:	48 89 d0             	mov    %rdx,%rax
 a11:	48 01 c0             	add    %rax,%rax
 a14:	48 01 d0             	add    %rdx,%rax
 a17:	48 c1 e0 04          	shl    $0x4,%rax
 a1b:	48 89 c2             	mov    %rax,%rdx
 a1e:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
 a22:	48 01 d0             	add    %rdx,%rax
 a25:	48 89 c1             	mov    %rax,%rcx
 a28:	e8 7b f6 ff ff       	call   a8 <crearProfesor>
 a2d:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
 a31:	8b 45 d8             	mov    -0x28(%rbp),%eax
 a34:	39 45 f8             	cmp    %eax,-0x8(%rbp)
 a37:	7c cf                	jl     a08 <main+0x1d1>
 a39:	8b 55 d8             	mov    -0x28(%rbp),%edx
 a3c:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
 a40:	48 89 c1             	mov    %rax,%rcx
 a43:	e8 b3 f9 ff ff       	call   3fb <mostrarProfesores>
 a48:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
 a4c:	48 89 c1             	mov    %rax,%rcx
 a4f:	e8 00 00 00 00       	call   a54 <main+0x21d>
 a54:	eb 79                	jmp    acf <main+0x298>
 a56:	8b 45 d8             	mov    -0x28(%rbp),%eax
 a59:	48 63 d0             	movslq %eax,%rdx
 a5c:	48 89 d0             	mov    %rdx,%rax
 a5f:	48 c1 e0 03          	shl    $0x3,%rax
 a63:	48 29 d0             	sub    %rdx,%rax
 a66:	48 c1 e0 03          	shl    $0x3,%rax
 a6a:	48 89 c1             	mov    %rax,%rcx
 a6d:	e8 00 00 00 00       	call   a72 <main+0x23b>
 a72:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
 a76:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
 a7d:	eb 2a                	jmp    aa9 <main+0x272>
 a7f:	8b 45 f4             	mov    -0xc(%rbp),%eax
 a82:	48 63 d0             	movslq %eax,%rdx
 a85:	48 89 d0             	mov    %rdx,%rax
 a88:	48 c1 e0 03          	shl    $0x3,%rax
 a8c:	48 29 d0             	sub    %rdx,%rax
 a8f:	48 c1 e0 03          	shl    $0x3,%rax
 a93:	48 89 c2             	mov    %rax,%rdx
 a96:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
 a9a:	48 01 d0             	add    %rdx,%rax
 a9d:	48 89 c1             	mov    %rax,%rcx
 aa0:	e8 b3 f7 ff ff       	call   258 <crearEstudiante>
 aa5:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
 aa9:	8b 45 d8             	mov    -0x28(%rbp),%eax
 aac:	39 45 f4             	cmp    %eax,-0xc(%rbp)
 aaf:	7c ce                	jl     a7f <main+0x248>
 ab1:	8b 55 d8             	mov    -0x28(%rbp),%edx
 ab4:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
 ab8:	48 89 c1             	mov    %rax,%rcx
 abb:	e8 dd fa ff ff       	call   59d <mostrarEstudiantes>
 ac0:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
 ac4:	48 89 c1             	mov    %rax,%rcx
 ac7:	e8 00 00 00 00       	call   acc <main+0x295>
 acc:	eb 01                	jmp    acf <main+0x298>
 ace:	90                   	nop
 acf:	b8 00 00 00 00       	mov    $0x0,%eax
 ad4:	48 83 c4 50          	add    $0x50,%rsp
 ad8:	5d                   	pop    %rbp
 ad9:	c3                   	ret
 ada:	90                   	nop
 adb:	90                   	nop
